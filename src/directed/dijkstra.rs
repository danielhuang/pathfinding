...
/// Information about a node reached by [`dijkstra_reach`](crate::directed::dijkstra::dijkstra_reach).
#[derive(Debug, Hash, PartialEq, Eq, Clone)]
pub struct DijkstraReachableItem<N, C> {
    /// The node that was reached by [`dijkstra_reach`](crate::directed::dijkstra::dijkstra_reach).
    pub node: N,
